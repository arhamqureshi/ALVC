...
from analyse_image import get_expected_result, compare
...
if __name__=="__main__":
    ...
    start = timer()
    timestamps = get_timestamps("sample/gameplay.mp4", sample_rate=30)
    end = timer()
    print("")
    print("Total Process Took {}s to Complete".format(end - start))
    print(timestamps)